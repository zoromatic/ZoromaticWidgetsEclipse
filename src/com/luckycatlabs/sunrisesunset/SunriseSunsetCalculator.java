...
public class SunriseSunsetCalculator {
     ...
     *            <code>SunriseSunsetLocation</code> object containing the Latitude/Longitude of the sunriseSunsetLocation to compute
     ...
     * @param latitude
     * @param longitude
     *            Coordinates for the sunriseSunsetLocation to compute the sunrise/sunset for.
     * @param timeZone
     *            timezone to compute the sunrise/sunset times in.
     * @param date
     *            <code>Calendar</code> object containing the date to compute the official sunset for.
