...
package com.zoromatic.sunrisesunset;

import java.util.Calendar;
import java.util.TimeZone;

import com.zoromatic.sunrisesunset.calculator.SolarEventCalculator;
...
public class SunriseSunsetCalculator {
    ...
    private SunriseSunsetLocation location;
     ...
     * 
     * @param location
     *            <code>SunriseSunsetLocation</code> object containing the Latitude/Longitude of the location to compute
     ...
     *            time zones.
     */
    public SunriseSunsetCalculator(SunriseSunsetLocation location, String timeZoneIdentifier) {
     ...
     */
    public SunriseSunsetCalculator(SunriseSunsetLocation location, TimeZone timeZone) {
     ...
     * 
     * @return <code>SunriseSunsetLocation</code> object representing the location of the computed sunrise/sunset.
     */
