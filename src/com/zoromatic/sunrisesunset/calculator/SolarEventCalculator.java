...
package com.zoromatic.sunrisesunset.calculator;
...
import com.zoromatic.sunrisesunset.Zenith;
...
public class SolarEventCalculator {
    final private SunriseSunsetLocation location;
     ...
     * 
     * @param location
     *            <code>SunriseSunsetLocation</code> of the place where the solar event should be calculated from.
     * @param timeZoneIdentifier
     *            time zone identifier of the timezone of the location parameter. For example,
     *            "America/New_York".
     */
    public SolarEventCalculator(SunriseSunsetLocation location, String timeZoneIdentifier) {
     ...
     */
    public SolarEventCalculator(SunriseSunsetLocation location, TimeZone timeZone) {
        this.location = location;
